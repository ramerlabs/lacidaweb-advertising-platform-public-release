...
const schema = z.object({
  ...
  usBankEnabled: z.boolean().optional(),
  usdtTrc20Wallet: z.string().optional(),
  paypalEmail: z.string().optional(),
  gcashNumber: z.string().optional(),
  usBankName: z.string().optional(),
  usBankAccountName: z.string().optional(),
  usBankAccountNumber: z.string().optional(),
  usBankRoutingNumber: z.string().optional(),
  usBankAccountType: z.string().optional(),
  usdtInstructions: z.string().optional(),
  paypalInstructions: z.string().optional(),
  gcashInstructions: z.string().optional(),
  usBankInstructions: z.string().optional(),
